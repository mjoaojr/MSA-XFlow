...
//	printf ("_gapPos1=%d, _gapPos2=%d\n", _gapPos1, _gapPos2);
	#pragma omp parallel for schedule (dynamic, 1) private(si, sj, i, n, m, len1, len2, res, seq1, seq2, _ptrToSeq1, _ptrToSeq2, _score, mmScore, _gapOpen, _gapExtend, maxScore, sb1, sb2, se1, se2, printPtr, lastPrint)
        //for (si = utilityObject->MAX(0, iStart); si < _numSeqs && si < iEnd; si++)
        for (si = utilityObject->MAX(0, iStart); si < _numSeqs; si++)
        {
...
//			printf ("(%d,%d);", i, len1);
	...
	//#pragma omp parallel private(si, sj, i, n, m, len1, len2, res, seq1, seq2, _ptrToSeq1, _ptrToSeq2, _gapPos1, _gapPos2, _score, mmscore) shared (_gapOpen, _gapExtend)
