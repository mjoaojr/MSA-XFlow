...
class ProbaPairwiseAlign : public PairwiseAlignBase
{
	...
	float proba_pair_wise (int s1, int s2);
	int get_tot_prob2 (int nstates, float **matchProb, float **insProb, float *TmatchProb, float ***TinsProb, int mode);
	float *forward_proba_pair_wise (int NumMatrixTypes, int NumInsertStates, float **transMat, vector<float> initialDistribution,float *matchProb, float ***insProb, float **transProb);
	float *backward_proba_pair_wise (int NumMatrixTypes, int NumInsertStates, float **transMat, vector<float> initialDistribution,float *matchProb, float ***insProb, float **transProb);
	float ProbaMatrix2CL (int NumMatrixTypes, int NumInsertStates, float *forward, float *backward, float thr, int s1, int s2, vector<float> &posterior);
