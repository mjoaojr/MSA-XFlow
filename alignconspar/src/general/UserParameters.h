...
class UserParameters
{
    public:
        ...
        string getSSName(){return ssName;};
        void setSSName(string value);
        string getCLName(){return clName;};
        ...
        bool getLcsPairAlign(){return lcsPairAlign;};
        void setLcsPairAlign(bool value);
        void toggleLcsPairAlign(); // Mark new!!!
        bool getKmersPairAlign(){return kmersPairAlign;};
        void setKmersPairAlign(bool value);
        void toggleKmersPairAlign(); // Mark new!!!
        bool getProbaPairAlign(){return probaPairAlign;};
        void setProbaPairAlign(bool value);
        void toggleProbaPairAlign(); // Mark new!!!
	...
	void setNthr(int num){nThreads = num;}
	int getNthr(){return nThreads;}
