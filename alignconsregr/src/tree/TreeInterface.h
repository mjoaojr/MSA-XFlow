...
class TreeInterface
{
    public:
         ...
         */
        unique_ptr<AlignmentSteps> getWeightsAndStepsFromDistMat(vector<int>* seqWeights, 
                                                          DistMatrix* distMat, 
                                                          Alignment *alignPtr, 
                                                          int seq1, int nSeqs, 
         ...
         */                                                  
        unique_ptr<AlignmentSteps> getWeightsAndStepsFromTree(Alignment* alignPtr, 
    ...
    private:
        unique_ptr<AlignmentSteps> getWeightsAndStepsFromDistMatNJ(vector<int>* seqWeights, 
                                                          DistMatrix* distMat, 
                                                          Alignment *alignPtr, 
                                                          int seq1, int nSeqs, 
                                                          string* phylipName, bool* success);
        
        unique_ptr<AlignmentSteps> getWeightsAndStepsUseOldGuideTreeNJ(DistMatrix* distMat, 
        ...
        int readTreeAndCalcWeights(Tree* groupTree, Alignment* alignPtr, 
                            DistMatrix* distMat, string* treeName, vector<int>* seqWeights,
                            int fSeq, int nSeqs);
        ...
        unique_ptr<AlignmentSteps> getWeightsAndStepsFromTreeNJ(Alignment* alignPtr, 
                               DistMatrix* distMat, string* treeName,
                               vector<int>* seqWeights, int fSeq, int numSeqs, bool* success);
        
        /** UPGMA functions */
        unique_ptr<AlignmentSteps> getWeightsAndStepsFromTreeUPGMA(Alignment* alignPtr, 
                               DistMatrix* distMat, string* treeName,
                               vector<int>* seqWeights, int fSeq, int numSeqs, bool* success);
        
        unique_ptr<AlignmentSteps> getWeightsAndStepsFromDistMatUPGMA(vector<int>* seqWeights, 
                                 DistMatrix* distMat, Alignment *alignPtr, 
                                 int seq1, int nSeqs, string* phylipName, bool* success);
                                 
        unique_ptr<AlignmentSteps> generateTreeFromDistMatUPGMA(RootedGuideTree* guideTree,
