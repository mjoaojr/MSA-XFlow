...
UserParameters::UserParameters(bool log)
{
   ...
   // setParamsToDefault (which is not used at all)
    ...
    lcsPairAlign = false;
    kmersPairAlign = false;
    probaPairAlign = false;
...
void UserParameters::setConsistency(bool value)
{
    consistency = value;
}
...
void UserParameters::setCLName(string value)
{
    clName = value;
}

void UserParameters::setSSName(string value)
{
    ssName = value;
}
...
void UserParameters::toggleLcsPairAlign()
{
    lcsPairAlign ^= true;
}

void UserParameters::toggleKmersPairAlign()
{
    kmersPairAlign ^= true;
}

void UserParameters::toggleProbaPairAlign()
{
    probaPairAlign ^= true;
}
...
void UserParameters::setLcsPairAlign(bool value)
{
    lcsPairAlign = value;
}

void UserParameters::setKmersPairAlign(bool value)
{
    kmersPairAlign = value;
}

void UserParameters::setProbaPairAlign(bool value)
{
    probaPairAlign = value;
}
