...
frmw_aligncons = '~/mnt/framework/alignconsregr/src/frmw_aligncons'
...
//	print (msf + ' to ' + outfile)
	...
	/usr/bin/cp $msf $outfile
        /home/ubuntu/mnt/BAliBASE_R9/src/bali_score ~/mnt/BAliBASE/RV913/$xml $outfile > eca
	...
	python3 ~/mnt/savescores3.py scores BAliBASE BB913
	"""
